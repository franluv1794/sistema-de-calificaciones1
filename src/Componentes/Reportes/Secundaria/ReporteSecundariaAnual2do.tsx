import "./ReporteSecundariaAnual2do.css";
...
const ReporteSecundariaAnual2do = ({ reportes, centro }: Props) => {
  ...
  return (
    <div className="reportes-anuales-secundaria">
      {reportes.map((r, index) => {
        ...
        return (
          <div className="reporte-2do-secundaria" key={r.idEstudiante ?? index}>
            <div className="r4-header">
              <div className="r4-logos">
              ...
              <div className="r4-grado">
                <span className="r4-numero">2</span>
                <div>
                  <span className="r4-er">do</span>
                  <span className="r4-grado-texto">Grado</span>
                  <p>PRIMER CICLO</p>
            ...
            <div className="r4-nombre-container">
              <div className="r4-nombre-label">NOMBRES Y APELLIDOS</div>
              <div className="r4-nombre-linea">
                <strong>{r.estudiante ?? r.Estudiante}</strong>
              </div>
            </div>

            <table className="r4-tabla">
              <thead>
                <tr>
                  <th rowSpan={4} className="r4-area">
            ...
            <div className="r4-bloque-observacion-competencias">
              <div className="r4-observaciones">
                <strong>Observaciones:</strong>
              </div>

              <div className="r4-competencias">
...
export default ReporteSecundariaAnual2do;