import "./ReportePrimariaAnual4to.css";
  ...
  return (
    <div className="reportes-primaria-anual">
      {reportes.map((r, index) => {
        ...
        return (
          <div className="reporte-4to-primaria" key={r.idEstudiante ?? index}>
            <div className="p4-header">
              <div className="p4-logos">
                <img src={logoImage} alt="Logo institución" className="p4-logo" />
              </div>
              ...
              <div className="p4-grado">
                <div className="p4-icono">✿</div>
                <h2>CUARTO GRADO</h2>
                <h3>NIVEL PRIMARIO</h3>
              </div>
            </div>

            <div className="p4-nombre-container">
              <div className="p4-nombre-label">NOMBRES Y APELLIDOS</div>
              <div className="p4-nombre-linea">
                <strong>{r.estudiante ?? r.Estudiante}</strong>
              </div>
            </div>

            <div className="p4-barra">DESEMPEÑO INDIVIDUAL DEL/LA ESTUDIANTE</div>

            <table className="p4-tabla">
              <thead>
                <tr>
                ...
                {materiasBase.map((nombreMateria, i) => {
                  ...
                  return (
                    <tr key={nombreMateria}>
                      {i === 0 && (
                        <td rowSpan={materiasBase.length} className="p4-area-vertical">
                          ÁREAS CURRICULARES
                        </td>
                      )}

                      <td className="p4-materia">{nombreMateria}</td>
            ...
            <table className="p4-observaciones">
              <tbody>
                {["P1", "P2", "P3", "P4"].map((p, i) => (
                  <tr key={p}>
                    {i === 0 && (
                      <td rowSpan={4} className="p4-observaciones-title">
                        OBSERVACIONES
                      </td>
                    )}
                    <td className="p4-periodo-label">{p}</td>
                    <td></td>
                  </tr>
                ))}
              </tbody>
...
export default ReportePrimariaAnual4to;